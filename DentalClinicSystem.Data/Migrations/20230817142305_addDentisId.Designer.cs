...
namespace DentalClinicSystem.Data.Migrations
{
    ...
    [Migration("20230817142305_addDentisId")]
    partial class addDentisId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlineAppointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OnlinePatientId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlinePatient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OnlinePatients");
                });

            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlinePatientAppointments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("OnlineAppointmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OnlineAppointmentId");

                    b.HasIndex("OnlinePatientId");

                    b.ToTable("OnlinePatientAppointments");
                });
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlineAppointment", b =>
                {
                    b.HasOne("DentalClinicSystem.Data.Models.Dentist", "Dentist")
                        .WithMany("OnlineAppointments")
                        .HasForeignKey("DentistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DentalClinicSystem.Data.Models.OnlinePatient", "OnlinePatient")
                        .WithMany("OnlineAppointments")
                        .HasForeignKey("OnlinePatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlinePatient", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "OnlineUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.OnlinePatientAppointments", b =>
                {
                    b.HasOne("DentalClinicSystem.Data.Models.OnlineAppointment", "OnlineAppointment")
                        .WithMany()
                        .HasForeignKey("OnlineAppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("OnlineAppointment");
            ...
            modelBuilder.Entity("DentalClinicSystem.Data.Models.Dentist", b =>
                {
                    ...
                    b.Navigation("OnlineAppointments");
                });
